...
next: 窗口 2 = P1-09 / P1-10 / P1-17（←16）+ P1-13（←12）——P1-17 共享基线已提交（914 零回归）；P1-09 查询 Run 路径设计已派 C（bcc46309）收敛；P1-10 / P1-13 基线待建; then 09/10/17 (after 16) and 13 (after 12); then 11 (after 10) and 14 (after 11+12); then 15 (after 09+14+17); gates: G2 waits 05+06+16, G4 waits 09+11, G5 waits 13+14, G3 waits 07+15
