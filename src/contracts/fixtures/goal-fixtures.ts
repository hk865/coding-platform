 ...
 */
import type { ActorRef, CreateGoalCommand, GoalCreatedEvent } from "../command-event.js";
import {
  commandFingerprint,
  normalizeObjective,
...
export function buildCreateGoalCommand(
  ...
  return {
    ...
    identity: {
      ...
      actor: { ...scope.actor },
      idempotencyKey: deps.idempotencyKey ?? MULTI_SCOPE_CREATE_GOAL_FIXTURE_V1.sharedIdempotencyKey,
    },
