/**
 * P1-04 deterministic check-provider doubles + the Reviewer capability double.
 * These are the ONLY CheckPort/ReviewerPort implementations P1-04 runs with;
 * real tools are later tickets. Determinism: the same ctx/checkId always
...
import { REVIEWER_MAX_PACKET_BYTES } from "../verification.js";
