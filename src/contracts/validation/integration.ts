/** integration protocol schema validation. Structural checks do not grant authority. */
import { INTEGRATION_MAX_CONFLICTS, INTEGRATION_MAX_EXPLANATION_BYTES, INTEGRATION_MAX_GAPS, INTEGRATION_MAX_INPUTS } from '../integration.js';
import { PATCH_MAX_CHANGED_PATHS, PATCH_MAX_CHECK_RESULTS, PATCH_MAX_CHECK_SUMMARY_BYTES, PATCH_MAX_USED_INPUT_EVIDENCE } from '../patch.js';
