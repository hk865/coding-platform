/** context protocol schema validation. Structural checks do not grant authority. */
import { canonicalJson } from '../fingerprint.js';
import { CONTINUATION_SUMMARY_MAX_BYTES, EXECUTION_NOTE_KINDS, EXECUTION_NOTE_MAX_ALTERNATIVES, EXECUTION_NOTE_MAX_BYTES, EXECUTION_NOTE_MAX_SOURCE_REFS, EXECUTION_NOTE_REASON_MAX_BYTES, EXECUTION_NOTE_SUMMARY_MAX_BYTES, WORK_CONTEXT_MAX_RUN_LINKS, WORK_KINDS } from '../context-continuity.js';
...
import { validateRoleBindingRef, validateDeclaredPermissions, validateRunRef } from './dispatch.js';
