...
import {
  INSPECTION_BRIEF_MAX_BYTES,
  INSPECTION_FINDING_MAX_BYTES,
  INSPECTION_FINDING_SUMMARY_MAX_BYTES,
  INSPECTION_MAX_OPTIONS,
  INSPECTION_MAX_REASONS,
  INSPECTION_MAX_SOURCES,
...
// ------------------------------------------------------------------------ //
// P1-12 architecture-inspection command/request validators                  //
// ------------------------------------------------------------------------ //
...
export function validateArchitectureInspectionIntent(value: unknown): ValidationIssue[] {
  ...
  if (!isRecord(budget)) {
    ...
    numberField(budget, "maxTokens", issues, "budget.maxTokens", 1);
