...
import { buildArchitectureEvolutionPolicyActivateCommand, buildArchitectureEvolutionPolicyInstallCommand } from "../contracts/commands/governance.js";
import type { GovernanceInstallLedgerCommitV1, GovernanceActivateLedgerCommitV1 } from "../contracts/ledger.js";
...
export function buildP113InstallCommand(fixture: VersionedArchitectureEvolutionPolicyFixture, deps: { commandId: string; projectId: string; idempotencyKey?: string; actor?: CommandIdentity["actor"] }): InstallArchitectureEvolutionPolicyRevisionCommand {
  return buildArchitectureEvolutionPolicyInstallCommand(fixture, {
