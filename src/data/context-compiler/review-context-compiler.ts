...
import { validateRoleBindingRef, validateTaskBudget } from '../../contracts/validation/dispatch.js';
...
export class ReviewContextCompilerImpl implements ReviewContextPort {
  ...
  async assemble(request: ReviewContextRequestV1): Promise<ReviewContextResultV1> {
    ...
    const bindingIssues: import("../../contracts/validation/common.js").ValidationIssue[] = [];
    validateRoleBindingRef(request.roleBinding, "roleBinding", bindingIssues);
    const budgetIssues: import("../../contracts/validation/common.js").ValidationIssue[] = [];
