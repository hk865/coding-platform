...
import { validateWorkspaceBootstrapCommand } from '../../contracts/validation/bootstrap.js';
...
import { resolveTaskWorkIdentity as resolveTaskWorkIdentityFromLedger } from "./work-identity-resolution.js";
...
import { AutonomousReworkEngineImpl } from "./autonomous-rework.js";
...
import { RoleSpecEngineImpl } from "./role-spec.js";
import { MaterialAccessEngineImpl } from "./material-access.js";
import { revokeMaterialAccess } from "./material-access-revocation.js";
...
export type ControlEngineDeps = {
  ...
  now: () => string;
  eventId: () => string;
  /** Control admission over explicit workspace support (unsupported until wired). */
...
export class ControlEngineImpl implements ControlEngine {
  ...
  private readonly autonomousRework: AutonomousReworkEngineImpl;
  ...
  constructor(deps: ControlEngineDeps) {
    ...
    this.roleSpec = new RoleSpecEngineImpl(deps);
    this.materialAccess = new MaterialAccessEngineImpl(deps);
  }

  registerWorkspace(command: import("../../contracts/workspace-registration.js").RegisterWorkspaceCommand): Promise<import("../../contracts/ledger.js").LedgerCommitReceipt> {
    return registerWorkspace(this.deps.ledger, command);
  }
   ...
   */
  resolveTaskWorkIdentity(
    query: import("../../contracts/task-work-identity.js").TaskWorkIdentityQuery,
  ): Promise<import("../../contracts/task-work-identity.js").TaskWorkIdentityResolution> {
    return resolveTaskWorkIdentityFromLedger({ ledger: this.deps.ledger }, query);
  }
  ...
  startQueryJob(command: import("../../contracts/query-job.js").StartQueryJobCommand): Promise<import("../../contracts/query-job.js").StartQueryJobReceipt> { return this.queryJob.start(command); }
  ...
  installRoleSpec(command: import("../../contracts/role-spec.js").InstallRoleSpecRevisionCommand): Promise<import("../../contracts/role-spec.js").InstallRoleSpecRevisionReceipt> {
    return this.roleSpec.install(command);
  }

  activateRoleSpec(command: import("../../contracts/role-spec.js").ActivateRoleSpecRevisionCommand): Promise<import("../../contracts/role-spec.js").ActivateRoleSpecRevisionReceipt> {
    return this.roleSpec.activate(command);
  }
  ...
  grantMaterialAccess(command: import("../../contracts/material-access.js").GrantMaterialAccessCommand): Promise<import("../../contracts/material-access.js").GrantMaterialAccessReceipt> {
    return this.materialAccess.grantMaterialAccess(command);
  }
  ...
  revokeMaterialAccess(command: import("../../contracts/material-access.js").RevokeMaterialAccessCommand): Promise<import("../../contracts/material-access.js").RevokeMaterialAccessReceipt> {
    return revokeMaterialAccess(this.deps, command);
  }
