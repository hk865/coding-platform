...
// Same source inventory as the architecture acceptance; output belongs to VR-01.
...
fs.writeFileSync(`evidence/2026-09-09-core-verification/${phase}-source-sha256.json`, JSON.stringify(snapshot, null, 2) + '\n');
