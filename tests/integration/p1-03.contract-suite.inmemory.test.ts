/**
 * P1-03 contract-suite wiring — InMemory adapter (REAL modules: InMemoryLedger +
 * ControlEngineImpl + ReadModelIndexImpl + ArtifactVault + ContextCompilerImpl +
 * FakeRuntimeAdapter + DispatchEngineImpl; no fakes). The SAME suite
 * definitions run against the SQLite wiring with identical assertions.
 */
