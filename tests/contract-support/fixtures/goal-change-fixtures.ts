...
import type { PlanProposalSnapshot, UserDecisionSnapshot, GoalRevisionV1, GoalRevisionSnapshot } from "../../../src/contracts/goal-change.js";
import type { AmendGoalRequestV1, PlanPatchV1, ChangeImpactAnalysisV1, PlanProposalV1, UserDecisionV1, PlanChangeViewQuery, RecordPlanChangeProposalCommand, RecordUserDecisionCommand, ApplyPlanChangeCommand } from "../../../src/contracts/goal-change.js";
