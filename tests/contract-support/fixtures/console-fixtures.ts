 ...
 */
import { consoleWorkspaceKey, consoleGoalKey, consoleTaskKey, CONSOLE_TIMELINE_MAX_ENTRIES } from "../../../src/contracts/console-views.js";
...
import type { DispatchClaimCommand, RunFactCommand, RoleBindingRefV1, RunRef, TaskBudgetV1 } from "../../../src/contracts/dispatch.js";
import { buildRunFactCommand } from "../../../src/fixtures/dispatch-fixtures.js";
...
import type { SubmitEvidenceCommand } from "../../../src/contracts/evidence.js";
import { buildReduceGoalCommand } from "./goal-phase-fixtures.js";
import type { ReduceGoalCommand } from "../../../src/contracts/goal-phase.js";
import { buildHandoffPacketV1, buildRecordHandoffCommand, buildClaimReplacementCommand } from "./handoff-fixtures.js";
import type { HandoffPacketV1, RecordHandoffCommand, ClaimReplacementCommand, HandoffPacketRef } from "../../../src/contracts/handoff.js";
...
export function buildP108ReduceTaskCommand(project: string, taskId: string, expectedRevision = 0): import("../../../src/contracts/reduction.js").ReduceTaskCommand {
...
export type P108HandoffDeps = {
  ...
  packetId: string;
  runRef: RunRef;
  attemptRef: import("../../../src/contracts/dispatch.js").TaskAttemptRef;
...
export type P108ReplacementDeps = {
  ...
  reason?: import("../../../src/contracts/handoff.js").ReplacementReason;
  expectedRevision?: number;
  roleBinding?: RoleBindingRefV1;
