 ...
 * path. Selection uses the existing completedWork module object.
 */
...
import type { CompletedWorkContextPort, CompletedWorkContextResultV1, CompletedWorkViewQuery, CompletedWorkViewResult } from "../../src/contracts/completed-work-context.js";
...
export async function runP117SelectionScenario(h: P1_17HarnessLike): Promise<P117SelectionScenarioResult> {
  ...
  const selection = await h.completedWork.assembleCompletedWorkContext(buildP117Request());
