/**
 * P1-06 restart evidence — repeatable:
 *   pnpm vitest run tests/restart/p1-06-restart.test.ts
 * AUTO-SKIPS until the P1-06 handlers/projections are implemented (no fake).
 */
