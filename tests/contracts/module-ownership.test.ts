...
const MODULE_FILE_INVENTORY: Readonly<Record<string, readonly string[]>> = {
  ...
  "PlanCompiler": ["feedback-decision-compiler.ts", "rework-proposal.ts", "execution-feedback-compiler.ts", "planning-work-materials.ts", "README.md", "initial-plan-compiler.ts", "operator-plan-compiler.ts", "plan-compiler.ts", "rework-plan-compiler.ts"],
